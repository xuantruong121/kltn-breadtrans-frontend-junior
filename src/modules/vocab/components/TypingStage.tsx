          ...
          <input
            ...
            className={`w-full border-2 rounded-2xl text-center text-xl font-semibold py-3.5 px-12 transition-all outline-none ${
              feedback === "CORRECT"
                ...
                : feedback === "INCORRECT"
                ? "border-rose-500 bg-rose-50 text-rose-950 dark:bg-rose-950/50 dark:text-rose-200 ring-4 ring-rose-100 dark:ring-rose-900/40"
                : "border-sky-400 focus:ring-4 focus:ring-sky-100 dark:focus:ring-sky-900/40 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 dark:border-slate-700"
            }`}
          />
