          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between text-xs font-bold text-slate-400 pt-2 border-t border-slate-100">
                ...
                <span>{book.totalWords} Từ vựng</span>
              </div>
            </motion.div>
          );
        })}
        ...
        {selectedBook.lessons.map((lesson) => {
          ...
          return (
            <button
              ...
              className={`px-4 py-2.5 rounded-2xl font-black text-sm whitespace-nowrap transition-all cursor-pointer ${
                isSelected
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between max-w-lg mx-auto px-2">
              ...
              <span className="font-extrabold text-emerald-600 text-sm flex items-center gap-1">
                <CheckCircle2 size={16} /> Đã thuộc: {masteredWords.length}/{words.length}
              </span>
            </div>
