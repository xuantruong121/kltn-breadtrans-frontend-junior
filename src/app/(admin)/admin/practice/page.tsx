...
import { Target, Plus, Loader2, Search, Trash2, X } from "lucide-react";
...
export default function AdminPracticePage() {
  ...
  const [category, setCategory] = useState("BILINGUAL_LEVEL");
  const [iconUrl, setIconUrl] = useState("target");
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filtered.map((topic) => (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-200 bg-white text-blue-600 shadow-xs shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold text-slate-400">
                      Thứ tự: {topic.order || 1} • {topic._count?.quizzes || 0}{" "}
                      bài tập
                    </span>
                  </div>
                </div>
          ...
          <div className="text-center py-16 text-slate-400 font-bold">
            Chưa có chủ đề luyện tập nào. Hãy bấm &quot;Tạo Chủ Đề Mới&quot; để
            thêm!
          </div>
        )}
      </div>
            ...
            <form onSubmit={handleCreateTopic} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    <option value="BILINGUAL_LEVEL">Đọc hiểu song ngữ</option>
                    <option value="GRAMMAR_TOPIC">Chuyên đề ngữ pháp</option>
                    <option value="GRAMMAR_LEVEL">
                      Ngữ pháp theo trình độ
                    </option>
                    <option value="GRAMMAR_MOCK_TEST">
                      Bài kiểm tra ngữ pháp
                    </option>
                    <option value="WRITING_PART1">Luyện viết phần 1</option>
                    <option value="WRITING_PART2">Luyện viết phần 2</option>
                  </select>
                </div>
