...
export default function WritingTopicsPage() {
  ...
  return (
    <div className="space-y-6 pb-20 pt-2">
      {/* Hero Banner */}
      <section className="relative overflow-hidden rounded-2xl border border-rose-200/80 dark:border-rose-900/40 bg-gradient-to-r from-rose-50 via-white to-pink-50/40 dark:from-slate-900 dark:via-slate-900/90 dark:to-slate-950 p-6 shadow-2xs sm:p-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="max-w-3xl space-y-3">
            <div className="inline-flex items-center gap-1.5 rounded-full border border-rose-200 dark:border-rose-800/60 bg-white/90 dark:bg-slate-800 px-3 py-1 text-xs font-extrabold text-rose-700 dark:text-rose-300">
            ...
            <div className="pt-1">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs font-extrabold text-rose-700 dark:text-rose-400 transition hover:text-rose-800 dark:hover:text-rose-300 hover:underline"
              >
          ...
          {/* Right KPI Card */}
          <div className="flex items-center gap-3.5 rounded-2xl border border-rose-200/90 dark:border-rose-900/50 bg-white/95 dark:bg-slate-900/95 px-5 py-4 shadow-2xs self-start md:self-auto shrink-0">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-rose-100 dark:bg-rose-950/60 text-rose-700 dark:text-rose-400">
        ...
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
          <button
            ...
            className={`inline-flex items-center gap-2 border-b-2 px-4 py-3 text-xs font-black transition whitespace-nowrap cursor-pointer ${
              selectedTab === "ALL"
                ? "border-rose-600 text-rose-900 dark:text-rose-400"
        ...
        <div className="flex flex-col gap-3.5">
          ...
          <div className="flex flex-wrap items-center gap-2 border-t border-slate-100 dark:border-slate-800 pt-3">
            ...
            <select
              ...
              className="min-h-9 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-2.5 text-xs font-bold text-slate-700 dark:text-slate-300 transition focus:border-rose-500 focus:bg-white dark:focus:bg-slate-900 focus:outline-hidden cursor-pointer"
            >
