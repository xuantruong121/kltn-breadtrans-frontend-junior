...
> = {
  LISTENING: {
    ...
    glowClass: "from-blue-400/10 to-indigo-400/20",
    badgeTheme: "border-blue-200 bg-blue-50 text-blue-700",
  ...
  READING: {
    ...
    glowClass: "from-emerald-400/10 to-teal-400/20",
    badgeTheme: "border-emerald-200 bg-emerald-50 text-emerald-700",
  ...
  SPEAKING: {
    ...
    glowClass: "from-violet-400/10 to-purple-400/20",
    badgeTheme: "border-violet-200 bg-violet-50 text-violet-700",
  ...
  WRITING: {
    ...
    glowClass: "from-rose-400/10 to-red-400/20",
    badgeTheme: "border-rose-200 bg-rose-50 text-rose-700",
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 pb-16">
      ...
      <section
        ...
        className="relative overflow-hidden rounded-3xl border border-amber-200/70 bg-gradient-to-br from-amber-500/10 via-orange-500/5 to-transparent p-6 shadow-xs sm:p-8 md:p-9"
      >
        {/* Soft Ambient Mesh Background Lights */}
        <div
          className="pointer-events-none absolute -right-16 -top-16 size-72 rounded-full bg-amber-400/15 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute -bottom-16 -left-16 size-72 rounded-full bg-orange-400/10 blur-3xl"
          aria-hidden="true"
        />
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-5">
            ...
            {isSkillsLoading && !skillsSummary ? (
              <div className="relative flex size-24 shrink-0 items-center justify-center rounded-2xl bg-white/90 p-2 shadow-xs ring-1 ring-amber-200/80 animate-pulse">
                <div className="size-16 rounded-full bg-amber-100/70" />
              </div>
            ) : (
              <div
                role="progressbar"
                ...
                className="relative flex size-24 shrink-0 items-center justify-center rounded-2xl bg-white/90 p-2 shadow-xs ring-1 ring-amber-200/80"
              >
            ...
            <div>
              {userTargetScore ? (
                <div className="inline-flex items-center gap-2 rounded-full border border-amber-300 bg-amber-100/70 px-3 py-1 text-xs font-bold text-amber-900">
                  <Target size={14} className="text-amber-700" aria-hidden="true" />
                  <span>Mục tiêu cá nhân: {userTargetScore}</span>
                </div>
              ) : (
                <Link
                  href="/student/profile"
                  className="inline-flex min-h-[32px] items-center gap-2 rounded-full border border-amber-300/80 bg-amber-50 px-3 py-1 text-xs font-bold text-amber-900 hover:bg-amber-100 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600"
                >
                  <Target size={14} className="text-amber-700" aria-hidden="true" />
                  <span>Thiết lập mục tiêu học tập</span>
                </Link>
              )}
              <h1 className="mt-2 text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-slate-900">
                Chào mừng trở lại, {studentName}!
              </h1>
              <p className="mt-1 text-sm sm:text-base font-medium text-slate-600 max-w-xl leading-relaxed">
                Tiến độ 4 kỹ năng: <span className="font-bold text-slate-900">{overallProgress.completedItems}/{overallProgress.totalItems}</span> bài đã hoàn thành ({overallProgress.progressPercent}%). Rèn luyện Nghe, Đọc, Nói, Viết để nâng cao trình độ tiếng Anh toàn diện.
              </p>
            </div>
          </div>
              ...
              <div className="flex w-full sm:w-auto sm:min-w-[200px] flex-col justify-center rounded-2xl border border-rose-200 bg-rose-50/90 px-4 py-2.5 shadow-xs">
                <div className="flex items-center justify-between text-xs font-bold text-rose-700">
                  ...
                  <button
                    ...
                    className="inline-flex min-h-[36px] items-center gap-1 text-[11px] font-extrabold text-rose-800 underline hover:no-underline cursor-pointer focus-visible:outline-2 focus-visible:outline-rose-600"
      ...
      {activeAttempt ? (
        <section
          ...
          className="relative overflow-hidden rounded-2xl border-2 border-emerald-300 bg-emerald-50/90 p-4 sm:p-5 shadow-xs transition-all hover:border-emerald-400"
        >
        ...
        <section
          ...
          className="relative overflow-hidden rounded-2xl border border-amber-200/80 bg-white/80 p-4 sm:p-5 shadow-2xs animate-pulse"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
        ...
        <section
          ...
          className="relative overflow-hidden rounded-2xl border border-rose-200 bg-rose-50/80 p-4 sm:p-5 shadow-2xs"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
        ...
        <section
          ...
          className="relative overflow-hidden rounded-2xl border border-amber-200/80 bg-white/90 p-4 sm:p-5 shadow-2xs backdrop-blur-xs"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
        ...
        <section
          ...
          className="relative overflow-hidden rounded-2xl border border-emerald-200 bg-emerald-50/80 p-4 sm:p-5 shadow-2xs"
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
      ...
      <section aria-labelledby="core-practice-heading" className="space-y-6">
        <div>
          <div className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-amber-700">
            <Target size={15} aria-hidden="true" />
            <span>Khu vực luyện thi tiêu chuẩn</span>
          </div>
          <h2 id="core-practice-heading" className="mt-1 text-2xl sm:text-3xl font-black text-slate-900">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="relative group bg-white rounded-3xl border-2 border-amber-200/80 hover:border-amber-400 p-6 sm:p-8 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden lg:col-span-2">
            {/* Ambient Background Glow on Hover */}
            <div
              className="pointer-events-none absolute -right-12 -top-12 size-48 rounded-full bg-gradient-to-br from-amber-400/20 via-orange-400/10 to-transparent blur-3xl group-hover:scale-125 transition-transform duration-500"
              aria-hidden="true"
            />
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="space-y-4 max-w-xl">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-700 inline-flex items-center gap-1">
                ...
                <div className="grid grid-cols-3 gap-3 border-t border-slate-100 pt-4">
                  <div>
                    ...
                    <p className="text-base sm:text-lg font-black text-slate-900">200 Câu hỏi</p>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Thời lượng</p>
                    <p className="text-base sm:text-lg font-black text-slate-900">120 Phút</p>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Chấm điểm</p>
                    <p className="text-base sm:text-lg font-black text-emerald-700">Thang 990</p>
                  </div>
                </div>
              </div>
            ...
            {/* Action Bar */}
            <div className="relative mt-6 flex flex-wrap items-center justify-between gap-4 border-t border-slate-100 pt-4">
          ...
          <div className="relative group bg-white rounded-3xl border-2 border-slate-100 hover:border-amber-300 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden">
            <div
              className="pointer-events-none absolute -right-8 -top-8 size-32 rounded-full bg-gradient-to-br from-amber-400/10 to-orange-400/20 blur-2xl group-hover:scale-150 transition-transform duration-500"
              aria-hidden="true"
            />
            ...
            <div>
              ...
              <div className="mt-5 space-y-2 rounded-2xl bg-slate-50 p-3.5 text-xs font-semibold text-slate-700">
                <div className="flex items-center justify-between">
                  <span className="text-slate-500">Số câu:</span>
                  <span className="font-extrabold text-slate-900">5 câu ngẫu nhiên</span>
                </div>
                <div className="flex items-center justify-between">
        ...
        <div id="skills-section" className="pt-4 scroll-mt-6">
          <div className="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
            <div>
              <div className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest text-blue-700">
          ...
          {isSkillsError ? (
            <div className="rounded-3xl border-2 border-rose-200 bg-rose-50/70 p-6 sm:p-8 text-center">
            ...
            <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
              {isSkillsLoading && !skillsSummary ? (
                ...
                Array.from({ length: 4 }).map((_, idx) => (
                  <div
                    key={idx}
                    className="rounded-3xl border-2 border-slate-100 bg-white p-6 shadow-xs flex flex-col justify-between min-h-[380px] animate-pulse"
                  >
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="h-6 w-24 rounded-full bg-slate-100" />
                        <div className="size-13 rounded-2xl bg-slate-100" />
                      </div>
                      <div className="h-6 w-36 rounded-lg bg-slate-100" />
                      <div className="space-y-2">
                ...
                skillsList.map((skill) => {
                  ...
                  return (
                    <div
                      key={skill.skill}
                      className={`relative group bg-white rounded-3xl border-2 border-slate-100 ${theme.hoverBorder} p-6 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden`}
                    >
                      {/* Hover Glow */}
                      <div
                      ...
                      <div>
                        ...
                        {/* Title & Description */}
                        <h4 className={`mt-4 text-xl font-black text-slate-900 ${theme.titleHover} transition-colors`}>
                          {skill.title}
                        </h4>
                        <p className="mt-2 text-sm font-medium text-slate-600 leading-relaxed">
                          {theme.description}
                        ...
                        <div className="mt-5 space-y-1.5">
                          <div className="flex items-center justify-between text-xs font-bold">
                            <span className="text-slate-500">Tiến độ kỹ năng</span>
                            {isZeroState ? (
                              <span className="inline-flex items-center gap-1.5 text-slate-400 font-extrabold">
                                <span className="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] text-slate-500 font-bold">
                                  Bắt đầu ngay
                                </span>
                                0%
                              </span>
      ...
      <section aria-labelledby="companion-heading" className="space-y-6 pt-4">
        ...
        <div className="relative overflow-hidden rounded-3xl border-2 border-amber-300 bg-gradient-to-r from-amber-500/15 via-orange-500/10 to-amber-100/40 p-6 sm:p-8 shadow-xs">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
              ...
              <div className="space-y-1">
                <div className="inline-flex items-center gap-1.5 rounded-full bg-amber-100 px-2.5 py-0.5 text-xs font-black text-amber-900">
                  <Trophy size={13} className="text-amber-700" aria-hidden="true" />
                  Đấu Trường Học Viên
                </div>
        ...
        <div>
          <h3 id="companion-heading" className="text-xl font-black text-slate-900 mb-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Link
              href="/flashcard"
              className="group relative flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-2xs hover:border-amber-300 hover:shadow-md transition duration-200"
            >
              <div>
                <div className="flex size-11 items-center justify-center rounded-xl border border-amber-200 bg-amber-50 text-amber-700">
                  <Layers size={20} aria-hidden="true" />
                </div>
                <h4 className="mt-3 text-base font-black text-slate-900 group-hover:text-amber-700 transition-colors">
                  Flashcard Từ Vựng
                </h4>
              ...
              <span className="mt-4 inline-flex items-center gap-1 text-xs font-extrabold text-amber-700">
            ...
            <Link
              href="/grammar"
              className="group relative flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-2xs hover:border-emerald-300 hover:shadow-md transition duration-200"
            >
              <div>
                <div className="flex size-11 items-center justify-center rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-700">
                  <BookMarked size={20} aria-hidden="true" />
                </div>
                <h4 className="mt-3 text-base font-black text-slate-900 group-hover:text-emerald-700 transition-colors">
                  Ngữ Pháp Tiếng Anh
                </h4>
                <p className="mt-1 text-xs font-medium text-slate-600 leading-relaxed">
            ...
            <Link
              href="/diagnostic"
              className="group relative flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-2xs hover:border-blue-300 hover:shadow-md transition duration-200"
            >
              <div>
                <div className="flex size-11 items-center justify-center rounded-xl border border-blue-200 bg-blue-50 text-blue-700">
                  <Compass size={20} aria-hidden="true" />
                </div>
                <h4 className="mt-3 text-base font-black text-slate-900 group-hover:text-blue-700 transition-colors">
                  Kiểm Tra Đầu Vào
                </h4>
                <p className="mt-1 text-xs font-medium text-slate-600 leading-relaxed">
            ...
            <Link
              href="/history"
              className="group relative flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-2xs hover:border-violet-300 hover:shadow-md transition duration-200"
            >
              <div>
                <div className="flex size-11 items-center justify-center rounded-xl border border-violet-200 bg-violet-50 text-violet-700">
                  <History size={20} aria-hidden="true" />
                </div>
                <h4 className="mt-3 text-base font-black text-slate-900 group-hover:text-violet-700 transition-colors">
                  Lịch Sử Luyện Tập
                </h4>
                <p className="mt-1 text-xs font-medium text-slate-600 leading-relaxed">
