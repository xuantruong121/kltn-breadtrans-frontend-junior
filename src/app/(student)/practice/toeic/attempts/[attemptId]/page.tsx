      ...
      <div className="mx-auto max-w-7xl space-y-4 sm:space-y-5">
        <header className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-slate-900 p-3 text-white sm:p-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {fullTest && <div className="hidden items-center gap-1.5 rounded-xl border border-slate-600 px-3 py-2 text-xs font-bold sm:flex"><Clock3 size={15} /> {readingPhase ? "Reading" : "Listening"} {formatTime(sectionRemaining)}</div>}
